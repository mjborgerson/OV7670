...
/**************************************************************
*  Init_OV7670.h
*  Header for OV7670 initialization
*  Thanks to ComputerNerd for  great code and comments
**************************************************************/

#ifndef  OV7670_REGDEFS
#define OV7670_REGDEFS
struct regval_entry {
  uint8_t reg_num;
  uint8_t value;
};
...
// CSI Register bit definitions from KurtE
